...
object IndicatorAnalyzer {
  ...
  private val df: WordDelimiterFilterFactory = new WordDelimiterFilterFactory
  private val tf: TrimFilterFactory = new TrimFilterFactory
}