...
object ComputexExample {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val primaryIndicators : List[Indicator] = SpreadsheetsFetcher.primaryIndicators
    val secondaryIndicators : List[Indicator] = SpreadsheetsFetcher.secondaryIndicators
    val components : List[Component] = SpreadsheetsFetcher.components
    val subindexes : List[SubIndex] = SpreadsheetsFetcher.subindexes
